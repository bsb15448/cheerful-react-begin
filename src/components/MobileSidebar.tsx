...
const MobileSidebar = ({
  ...
  const mainCategories = [{
    id: 'pretAPorter',
    title: t('categories.pretAPorter.title'),
    description: t('categories.pretAPorter.description'),
    subcategories: [{
      id: 'all',
      title: t('categories.pretAPorter.all'),
      items: [{
        key: 'chemise',
        label: t('items.chemise')
      }, {
        key: 'tshirt',
        label: t('items.tshirt')
      }, {
        key: 'polo',
        label: t('items.polo')
      }, {
        key: 'chaussure',
        label: t('items.chaussure')
      }, {
        key: 'ceinture',
        label: t('items.ceinture')
      }, {
        key: 'maroquinerie',
        label: t('items.maroquinerie')
      }]
    }]
  }, {
    id: 'accessoires',
    title: t('categories.accessoires.title'),
    description: t('categories.accessoires.description'),
    subcategories: [{
      id: 'all',
      title: t('categories.accessoires.all'),
      items: [{
        key: 'montre',
        label: t('items.montre')
      }, {
        key: 'lunettes',
        label: t('items.lunettes')
      }, {
        key: 'parfum',
        label: t('items.parfum')
      }]
    }]
  }, {
    id: 'boutique',
    title: t('categories.boutique.title'),
    description: t('categories.boutique.description'),
    subcategories: [{
      id: 'all',
      title: t('categories.boutique.all'),
      items: []
    }]
  }];
          ...
          <div className="p-4 border-t border-gray-200 bg-gray-50/50 flex-shrink-0">
            ...
            <div className="bg-white rounded-lg p-2 mb-3 border border-gray-200 shadow-sm">
              <div className="text-center">
                <h4 className="text-xs font-medium text-gray-800 mb-2">{t('contact.title')}</h4>
                ...
                <h4 className="text-xs font-medium text-gray-800 mb-2">{t('currency.title')}</h4>
