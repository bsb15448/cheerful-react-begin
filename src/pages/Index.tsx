...
const Index = () => {
  ...
  const bookImages = [{
    src: "/lovable-uploads/e4c91fce-bc18-4e42-a454-1f9b8fece80e.png",
    alt: "Thomas and the Magical Judo Adventure"
  }, {
    src: "/lovable-uploads/cc3ab2c5-c5af-410e-9519-7abddb26f463.png",
    alt: "Alice Among the Enchanted Dreams"
  }, {
    src: "/lovable-uploads/a31deb8f-2367-4b2f-9f45-dc71395ca637.png",
    alt: "The Magical Unicorn of Friendship"
  }, {
    src: "/lovable-uploads/ac211a5b-23aa-4b92-b8f2-12693406447c.png",
    alt: "James Space Flight"
  }, {
    src: "/lovable-uploads/2aa94214-a9cb-4f40-b86d-34f78fbdc3d5.png",
    alt: "The Magic Forest Adventure"
  }, {
    src: "/lovable-uploads/dc8b5a6e-b2fb-4dd7-96e5-cf214ec005b4.png",
    alt: "Cardboard the Brave Dinos Adventure"
  }];
              ...
              <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="flex-1 text-center lg:text-left relative">
                  ...
                  <div className="relative z-10 mt-[-7%] lg:mt-[-7%] md:mt-8">
                    <h1 className="hidden lg:block text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 leading-tight">
                      Créez votre livre personnalisé pour enfants
                    </h1>
                     <h1 className=" invisible text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 leading-tight">
                      Créez votre livre personnalisé pour enfants
                    </h1>
                    {/* Desktop version - full text */}
                    <p className="hidden lg:block text-lg md:text-xl text-gray-600 mb-8 max-w-1xl mt-[-25%]">Concevez un livre unique pour vos enfants , adapté spécifiquement à chaque enfant. Donnez vie à une histoire personnalisée et à des illustrations époustouflantes.</p>
                    
                    {/* Mobile version - shorter text with image - moved up */}
                    <div className="lg:hidden flex items-center gap-2 mb-1 max-w-2xl mt-[-37%]">
  ...
  <img src="/lovable-uploads/kid.png" alt="Background behind left and middle books" className="w-full h-[250px] object-contain" />
                      </div>
                  ...
                  <div className="max-w-md mx-auto relative z-10">
                    ...
                    <div className="relative h-72 w-full pt-12 mt-[-20%] py-[28px]">
                       ...
                       <div ref={book1Animation.ref} className={`absolute transform hover:scale-105 transition-all duration-500 ${book1Animation.isVisible ? 'animate-fade-in' : 'opacity-0'} cursor-pointer`} onClick={() => openCarousel(0)} style={{
                            width: '83px',
                            // Fixed width - won't change
                            height: '128px',
                            // Fixed height - won't change
                            top: '39%',
                            // Vertical position - adjust as needed
                            left: '1.5%',
                            // Horizontal position - shifted another 1% left
                            zIndex: 10
                          }}>
                       ...
                       <div ref={book2Animation.ref} className={`absolute transform hover:scale-105 transition-all duration-500 ${book2Animation.isVisible ? 'animate-fade-in' : 'opacity-0'} cursor-pointer`} onClick={() => openCarousel(1)} style={{
                            width: '83px',
                            // Fixed width - won't change
                            height: '128px',
                            // Fixed height - won't change
                       ...
                       <div ref={book3Animation.ref} className={`absolute transform hover:scale-105 transition-all duration-500 ${book3Animation.isVisible ? 'animate-fade-in' : 'opacity-0'} cursor-pointer`} onClick={() => openCarousel(2)} style={{
                            width: '81px',
                            // Fixed width - won't change
                            height: '128px',
                            // Fixed height - won't change
                       ...
                       <div ref={book4Animation.ref} className={`absolute transform hover:scale-105 transition-all duration-500 ${book4Animation.isVisible ? 'animate-fade-in' : 'opacity-0'} cursor-pointer`} onClick={() => openCarousel(3)} style={{
                            width: '83px',
                            // Fixed width - won't change
                            height: '100px',
                            // Fixed height - won't change
                       ...
                       <div ref={book5Animation.ref} className={`absolute transform hover:scale-105 transition-all duration-500 ${book5Animation.isVisible ? 'animate-fade-in' : 'opacity-0'} cursor-pointer`} onClick={() => openCarousel(4)} style={{
                            width: '83px',
                            // Fixed width - won't change
                            height: '124px',
                            // Fixed height - won't change
                       ...
                       <div ref={book6Animation.ref} className={`absolute transform hover:scale-105 transition-all duration-500 ${book6Animation.isVisible ? 'animate-fade-in' : 'opacity-0'} cursor-pointer`} onClick={() => openCarousel(5)} style={{
                            width: '83px',
                            // Fixed width - won't change
                            height: '128px',
                            // Fixed height - won't change
                      ...
                      <div className="absolute transform hover:scale-105 transition-all duration-500 cursor-pointer" onClick={() => openCarousel(5)} style={{
                            width: '83px',
                            // Fixed width - won't change
                            height: '128px',
                            // Fixed height - won't change
                            ...
                            // Vertical position - adjust as needed
                            left: '73.5%',
                            // Horizontal position - adjust as needed
                            zIndex: 10
                          }}>
                        <div className="relative w-full h-full rounded-lg" style={{
                    ...
                    <Button onClick={handlePersonalizeClick} className="w-full h-12 mt-[8%] bg-gradient-to-r from-[#a6428d] to-purple-400 hover:from-[#924077] hover:to-purple-300 text-white font-medium text-base rounded-lg shadow-lg transform transition-all duration-200 hover:scale-105 sm:w-auto sm:px-8 flex items-center justify-center gap-2">
                      JE PERSONALISE MON HISTOIRE
                      <ChevronRight className="w-5 h-5 animate-arrow-bounce" strokeWidth={3} />
                    </Button>
                  </div>
                </div>
  ...
  <div className="container mx-auto px-6">
    <div className="max-w-5xl mx-auto">
      ...
      <div className="text-center mb-8 md:mb-12">
        <h2 className="text-2xl md:text-4xl lg:text-4xl font-bold text-gray-800">
          COMMENT ÇA MARCHE
        </h2>
      </div>
      ...
      <div ref={step1Animation.ref} className={`flex flex-col lg:flex-row items-center gap-8 mb-6 transition-all duration-700 ${step1Animation.isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="flex-1 flex justify-center order-1 lg:order-1">
          <div className="relative">
            <img alt="Personnalisation héros" src="/lovable-uploads/13d2bd7c-0fd7-48b9-89ec-5a1de54016a9.png" className="w-72 h-72 object-cover mt-[-10%]" />
          </div>
        </div>
        <div className="flex-1 text-left order-2 lg:order-2">
          <div className="flex items-center justify-start mb-3">
            ...
            <h3 className="text-xl font-bold text-gray-800 md:text-2xl">Vous personnalisez votre héros</h3>
          </div>
          <p className="text-base text-gray-600 leading-relaxed">
            Indiquez le prénom, l’âge, l’objectif éducatif, votre message personnalisé et ajoutez une photo.
          </p>
        </div>
      </div>
      ...
      <div ref={step2Animation.ref} className={`flex flex-col lg:flex-row items-center gap-8 mb-6 transition-all duration-700 ${step2Animation.isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="flex-1 text-left order-2 lg:order-1">
          <div className="flex items-center justify-start mb-3">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-800">Vous choisissez le thème de l’histoire</h3>
          </div>
          <p className="text-base text-gray-600 leading-relaxed">
            Vous sélectionnez une thématique qui correspond aux besoins de votre enfant (confiance, courage, partage, etc). <br />
            Chaque histoire est conçue pour l’aider à grandir avec les bonnes valeurs.
          </p>
        </div>
        <div className="flex-1 flex justify-center order-1 lg:order-2">
          <div className="relative">
            <img alt="Choix du thème" src="/lovable-uploads/3ec02707-40fc-4a2a-a282-cd23fd929c56.png" className="w-72 h-72 object-cover" />
          </div>
        </div>
      </div>
      ...
      <div ref={step3Animation.ref} className={`flex flex-col lg:flex-row items-center gap-8 mb-6 transition-all duration-700 ${step3Animation.isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="flex-1 flex justify-center order-1 lg:order-1">
          <div className="relative">
            <img alt="Livre personnalisé" src="/lovable-uploads/e0e26efc-2cdf-4f67-ac48-d968d3485b52.png" className="w-72 h-72 object-cover" />
          </div>
        </div>
        <div className="flex-1 text-left order-2 lg:order-2">
          <div className="flex items-center justify-start mb-3">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-800">Nous créons son livre magique, rien que pour lui</h3>
          </div>
          <p className="text-base text-gray-600 leading-relaxed">
            Recevez chez vous un livre personnalisé, illustré avec amour, où votre enfant est le héros de sa propre aventure.
          </p>
        </div>
      </div>
      ...
      <div className="text-center flex justify-center">
        <Button onClick={handlePersonalizeClick} className="h-12 bg-gradient-to-r from-[#a6428d] to-purple-400 hover:from-[#924077] hover:to-purple-300 text-white font-medium text-base rounded-lg shadow-lg transform transition-all duration-200 hover:scale-105 px-6 py-3 flex items-center justify-center gap-2">
          ...
          <div className="py-12 md:py-16 relative z-[998]">
            <div className="container mx-auto px-4">
              ...
              <div className="hidden md:block">
                <div ref={desktopScrollRef} className="flex gap-8 overflow-x-auto scrollbar-hide max-w-full">
                   {/* Card 1 */}
                   <div className="min-w-[650px] max-w-[650px] bg-white rounded-2xl shadow-lg overflow-hidden flex h-[380px] impact-card-1 flex-shrink-0">
                   ...
                   {/* Card 2 */}
                   <div className="min-w-[650px] max-w-[650px] bg-white rounded-2xl shadow-lg overflow-hidden flex h-[380px] impact-card-2 flex-shrink-0">
                    <div className="flex-1 p-8 flex flex-col">
                   ...
                   {/* Card 3 */}
                   <div className="min-w-[650px] max-w-[650px] bg-white rounded-2xl shadow-lg overflow-hidden flex h-[380px] impact-card-3 flex-shrink-0">
                    <div className="flex-1 p-8 flex flex-col">
              ...
              <div className="md:hidden">
                <div ref={mobileScrollRef} className="flex gap-4 overflow-x-auto scrollbar-hide px-4 max-w-full mt-[-5%]">
                   {/* Card 1 Mobile */}
                   <div className="min-w-[80vw] max-w-[80vw] bg-white rounded-2xl shadow-lg overflow-hidden h-[550px] impact-card-1 flex-shrink-0">
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        ...
                        <div className="mt-4">
                          <Button onClick={handlePersonalizeClick} variant="outline" className="w-full h-10 border-2 border-[#a6428d] text-[#a6428d] bg-transparent hover:bg-[#a6428d] hover:text-white font-medium text-xs rounded-lg transition-all duration-200 flex items-center justify-center gap-2">
                            Je personnalise mon histoire
                            <ChevronRight className="w-4 h-4 animate-arrow-bounce" strokeWidth={3} />
                          </Button>
                        </div>
                      </div>
                    </div>
                   ...
                   {/* Card 2 Mobile */}
                   <div className="min-w-[80vw] max-w-[80vw] bg-white rounded-2xl shadow-lg overflow-hidden h-[550px] impact-card-2 flex-shrink-0">
                    <div className="w-full h-72">
                   ...
                   {/* Card 3 Mobile */}
                   <div className="min-w-[80vw] max-w-[80vw] bg-white rounded-2xl shadow-lg overflow-hidden h-[550px] impact-card-3 flex-shrink-0">
                    <div className="w-full h-72">
      ...
      <Dialog open={isCarouselOpen} onOpenChange={setIsCarouselOpen}>
        <DialogContent className="max-w-[100vw] max-h-[100vh] w-full h-full p-0 bg-gradient-to-br from-purple-900/95 via-black/95 to-blue-900/95 border-none z-[9999] backdrop-blur-md">
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <button onClick={prevImage} className="absolute left-2 sm:left-6 z-50 p-3 sm:p-4 bg-white/10 backdrop-blur-md text-white rounded-full hover:bg-white/20 hover:scale-110 transition-all duration-300 border border-white/20 shadow-xl group">
            ...
            <div className="w-full h-full flex items-center justify-center p-4 sm:p-12">
              <div className="relative max-w-full max-h-full">
                <img key={currentCarouselIndex} src={bookImages[currentCarouselIndex]?.src} alt={bookImages[currentCarouselIndex]?.alt} className="max-w-full max-h-full object-contain rounded-2xl shadow-2xl animate-fade-in border-4 border-white/20" style={{
            ...
            <button onClick={nextImage} className="absolute right-2 sm:right-6 z-50 p-3 sm:p-4 bg-white/10 backdrop-blur-md text-white rounded-full hover:bg-white/20 hover:scale-110 transition-all duration-300 border border-white/20 shadow-xl group">
              <ChevronRight className="w-5 h-5 sm:w-7 sm:h-7 transition-transform group-hover:translate-x-1 duration-300" strokeWidth={3} />
            </button>
            ...
            <div className="absolute bottom-6 sm:bottom-10 left-1/2 transform -translate-x-1/2 z-50 flex gap-3">
              {bookImages.map((_, index) => <button key={index} onClick={() => setCurrentCarouselIndex(index)} className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full transition-all duration-300 hover:scale-125 ${index === currentCarouselIndex ? 'bg-gradient-to-r from-purple-400 to-blue-400 shadow-lg scale-125 border-2 border-white/50' : 'bg-white/30 hover:bg-white/50 border border-white/30'}`} />)}
            </div>
            ...
            <div className="absolute inset-0 pointer-events-none">
              ...
              <div className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-blue-500/10 rounded-full blur-3xl animate-pulse" style={{
              animationDelay: '1s'
            }} />
              <div className="absolute top-3/4 left-1/3 w-24 h-24 bg-pink-500/10 rounded-full blur-3xl animate-pulse" style={{
              animationDelay: '2s'
            }} />
            </div>
          </div>
