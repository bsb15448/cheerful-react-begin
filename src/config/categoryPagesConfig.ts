...
export const categoryPagesConfig: Record<string, CategoryPageConfig> = {
  ...
  "vetements-travail/gilets": {
    title: "Gilets de Travail",
    description: "Gilets professionnels robustes et fonctionnels pour tous les métiers",
    bannerImage: "/Subitems/Banners/VetementDeServiceBannerSubitems.png",
    features: [
      {
        title: "Durabilité",
        description: "Matériaux résistants pour une utilisation quotidienne intensive"
      ...
      {
        title: "Confort",
        description: "Conçus pour offrir une liberté de mouvement optimale"
      }
    ],
    categoryType: "vetements-travail",
    parentCategory: "Vêtements de Travail"
  ...
  "produits-marketing/sacs": {
    title: "Sacs Personnalisables",
    description: "Sacs personnalisables pour votre communication d'entreprise",
    bannerImage: "/Subitems/Banners/ProduitsPersonalisableBanner.png",
    features: [
      {
        title: "Personnalisation",
        description: "Design sur mesure selon vos besoins"
