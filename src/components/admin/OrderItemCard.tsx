...
const OrderItemCard = ({ item, index }: OrderItemCardProps) => {
  ...
  console.log('OrderItemCard data for', item.child_name, ':', {
    child_eye_color: item.child_eye_color,
    child_remarks: item.child_remarks,
    ...
    <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 text-orange-700 text-sm">
          ...
          {item.child_remarks && (
            <p><strong>Remarques:</strong> {item.child_remarks}</p>
          )}
        </div>
      </div>
    </div>
