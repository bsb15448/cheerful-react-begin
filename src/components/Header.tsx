...
export default function Header() {
  ...
  const currentFlag = languages.find(l => l.code === locale) || languages[0];
        ...
        <div className="section-padding flex items-center justify-between h-[72px] lg:h-[88px] max-w-[1400px] mx-auto w-full">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <div ref={langRef} className="relative">
              ...
              >
                <img src={currentFlag.flag} alt="" className="w-6 h-4 rounded-[2px] object-cover" />
                <svg
                    ...
                    {languages.map((lang) => (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-2.5 text-left hover:bg-brand-gold/10 transition-colors duration-200 ${
                          locale === lang.code ? 'bg-brand-gold/5' : ''
                        }`}
                      >
            ...
            <a href="#booking" className="btn-primary text-[13px] !py-3 !px-7">
