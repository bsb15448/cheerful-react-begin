...
try {
    ...
    try {
        ...
        foreach ($children as $child) {
            ...
            $child_stmt->bindParam(':eye_color', $child['eyeColor'] ?? '');
            $child_stmt->bindParam(':remarks', $child['remarks'] ?? '');
            $child_stmt->execute();
            ...
            $item_stmt->bindParam(':child_eye_color', $child['eyeColor'] ?? '');
            $item_stmt->bindParam(':child_remarks', $child['remarks'] ?? '');
