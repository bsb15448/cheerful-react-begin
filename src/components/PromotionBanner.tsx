...
const PromotionBanner = () => {
  ...
  const promotions = [
    {
      id: 1,
      title: t('fallCollection.title'),
      subtitle: t('fallCollection.subtitle'),
      description: t('fallCollection.description'),
      buttonText: t('fallCollection.button'),
    ...
    },
    {
      ...
      buttonText: t('freeShipping.button'),
