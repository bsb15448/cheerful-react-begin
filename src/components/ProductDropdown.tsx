...
const ProductDropdown: React.FC<ProductDropdownProps> = ({ isOpen, activeCategory, onClose }) => {
  ...
  const getCategoryImage = (categoryKey: string | null) => {
    const categoryImages = {
      ...
      boutique: 'https://placeholder.co/800x800/e5e7eb/6b7280?text=Boutique'
    };
    return categoryImages[categoryKey as keyof typeof categoryImages] || categoryImages.pretAPorter;
  };
