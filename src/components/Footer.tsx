          ...
          <div className="py-4 border-t border-blue-300/30">
            <div className="container mx-auto px-4">
              ...
              <div className="hidden md:flex items-center justify-between text-sm">
                ...
                <div className="flex items-center space-x-6">
                  <a href="/privacy-policy" className="hover:text-blue-200 transition-colors">
                    Politique de confidentialité
                  </a>
                  <a href="/refund-policy" className="hover:text-blue-200 transition-colors">
                    Politique de remboursement
                  </a>
                  <a href="/terms-of-service" className="hover:text-blue-200 transition-colors">
                    Conditions d'utilisation
                  </a>
                  <a href="/shipping-policy" className="hover:text-blue-200 transition-colors">
                    Politique d'expédition
                  </a>
                  <a href="/coordonnees" className="hover:text-blue-200 transition-colors">
                    Coordonnées
                  </a>
                  <a href="/conditions-generales" className="hover:text-blue-200 transition-colors">
